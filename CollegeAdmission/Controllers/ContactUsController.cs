...
namespace CollegeAdmission.Controllers
{
    namespace CollegeAdmission.Controllers
    {
        public class ContactUsController : Controller
        {
            ...
            public ContactUsController(CollegeAdmissionContext context)
            {
                _context = context;
            }
            ...
            public async Task<IActionResult> Create([Bind("Id,Name,Email,Address,Message")] ContactUs ContactUs)
            {
            ...
            [HttpPost]
            [ValidateAntiForgeryToken]
            public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Email,Address,Message")] ContactUs ContactUs)
            {
                if (id != ContactUs.Id)
                {
                    return NotFound();
